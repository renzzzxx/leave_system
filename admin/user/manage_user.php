			...
			<form action="" id="manage-user">	
				...
				<div class="form-group col-6">
					...
					<select name="type" id="type" class="custom-select">
						...
						<option value="2" <?php echo isset($meta['type']) && $meta['type'] == 2 ? 'selected' : '' ?>>Approver 1</option>
						<option value="3" <?php echo isset($meta['type']) && $meta['type'] == 3 ? 'selected' : '' ?>>Approver 2</option>
					</select>
				</div>
				<div class="form-group col-6">
